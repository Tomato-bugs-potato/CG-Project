           ...
           <div className="flex flex-row items-center justify-center fixed top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%]">
               <div className="flex flex-col items-center justify-center gap-2 bg-white p-10 md:p-24 m-0 rounded-[1rem_1rem_1rem_1rem]">
                   ...
                   <TextInput 
                    ...
                    />
                   <Button className="bg-violet-600 shadow-xl" onClick={handleLogin}>Sign in</Button>
                   <button 
                        onClick={singInWithGoogle} 
                        className="flex flex-row items-center justify-center gap-3 rounded-xl text-sm font-medium text-gray-600 border border-gray-300 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-gray-600 focus:ring-offset-2 focus:ring-offset-gray-100 p-3"
                    >
                   ...
                   <p>already have an account? <a className="text-violet-600" href="/auth">sign up</a></p>
               </div>
